defmodule AstartisWeb.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind astartis_web", "esbuild astartis_web"],
      "assets.deploy": [
        "tailwind astartis_web --minify",
        "esbuild astartis_web --minify",
        "phx.digest"
      ],
